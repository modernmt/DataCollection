...
def read_domains(domainstats):
    valid_tlds = set()
    uri_dict = {}
    for line in args.domainstats:
...
if __name__ == "__main__":
    ...
    parser.add_argument('domainstats', type=open_file,
                        help='file containing language stats per domain')
    ...
    valid_tlds, uri_dict = read_domains(args.domainstats)
